...
class attendance:
    def __init__(self,root):
        ...
        main_frame=Frame(bd=2,bg="gray")
        main_frame.place(x=0,y=50,width=1530,height=1000)

        #left label frame
        Left_frame=LabelFrame(main_frame,bd=2,relief=RIDGE,text="Student Attendance Details",font=("times new roman",12,"bold"))
        Left_frame.place(x=10,y=10,width=780,height=1000)  

        left_inside_frame=LabelFrame(Left_frame,bd=2,relief=RIDGE,font=("times new roman",12,"bold"))
        left_inside_frame.place(x=5,y=0,width=765,height=370)
        ...
        attendaceId_entry=ttk.Entry(left_inside_frame,width=20,textvariable=self.var_atten_id,font=("comicsansns",11,"bold"))
        attendaceId_entry.grid(row=0,column=1,padx=10,pady=5,sticky=W)

        #roll
        rolllabel=Label(left_inside_frame,text="Student Roll:",bg="White",font=("comicsansns",11,"bold"))
        ...
        #name
        namelabel=Label(left_inside_frame,text="Student Name:",bg="White",font=("comicsansns",11,"bold"))
        ...
        btn_frame.place(x=0,y=300,width=761,height=35)
        ...
        right_frame.place(x=790,y=10,width=730,height=1000)  

        table_frame=Frame(right_frame,bd=2,relief=RIDGE,bg="white")
        table_frame.place(x=5,y=5,width=720,height=370)
    ...
    def exportCsv(self):
        try:
            ...
            with open(fln,mode="w",newline="") as myfile:
                ...
                messagebox.showinfo("Data Export","Yours data exported to "+os.path.basename(fln)+" Successfully")
